                ...
                <form action="/tender" method="POST">
                    ...
                    <label class="form-control w-full mt-2">
                        ...
                        <input name="judul" type="text" placeholder="Tulis disini"
                            class="input input-bordered w-full" value="{{ old('judul') }}" />
                        @error('judul')
                            <p class="text-sm text-rose-400 mt-2">{{ $message }}</p>
                        @enderror
                    </label>
                    <label class="form-control w-full mt-2">
                        ...
                        <input name="deskripsi" type="text" placeholder="Tulis disini"
                            class="input input-bordered w-full" value="{{ old('deskripsi') }}" />
                        @error('deskripsi')
                            <p class="text-sm text-rose-400 mt-2">{{ $message }}</p>
                        @enderror
                    </label>
                    ...
                    <label class="form-control w-full mt-2">
                        ...
                        <input name="tgl_buka" type="date" placeholder="Tulis disini"
                            class="input input-bordered w-full" value="{{ old('tgl_buka', date('Y-m-d')) }}" />
                        @error('tgl_buka')
                            <p class="text-sm text-rose-400 mt-2">{{ $message }}</p>
                        @enderror
                    </label>
                    <label class="form-control w-full mt-2">
                        ...
                        <input name="tgl_tutup" type="date" placeholder="Tulis disini"
                            ...
                            value="{{ old('tgl_tutup', Carbon\Carbon::tomorrow()->format('Y-m-d')) }}" />
                        @error('tgl_tutup')
                            <p class="text-sm text-rose-400 mt-2">{{ $message }}</p>
                        @enderror
                    </label>
                    ...
                    <div class="flex gap-2 mt-8">
                        ...
                        <button class="btn btn-primary w-1/2">Ajukan Tender</button>
                    </div>
