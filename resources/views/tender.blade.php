<x-app-layout>
    ...
    <x-drawer>
        ...
        <div class="p-8">
            ...
            <a href="/tender/create" class="btn btn-primary my-4">Ajukan Tender <svg xmlns="http://www.w3.org/2000/svg"
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="flex gap-2">
                                        <a href="/tender/{{ $tender->id }}" class="btn btn-xs btn-info">View</a>
