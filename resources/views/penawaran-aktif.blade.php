<x-app-layout>
    ...
    <x-drawer>
        ...
        <div class="p-8">
            <h1 class="text-4xl font-semibold mb-4 text-white">Pengumuman Tender</h1>
            <div class="bg-gray-900 p-4 h-max rounded-xl overflow-hidden overflow-x-auto mt-8">
                ...
                <div role="tablist" class="tabs tabs-boxed max-w-xl mb-4 bg-gray-800">
                    ...
                    <a href="/penawaran/active" role="tab" class="tab tab-active">Tender Aktif ({{ $activeTendersCount }})</a>
                    ...
                    <tbody>
                        @foreach ($tenders as $tender)
                            <tr>
                                ...
                                <td>
                                    <a href="/penawaran/{{ $tender->id }}" class="btn btn-info btn-xs">Lihat
                                        Pemenang</a>
                                </td>
                            </tr>
                        @endforeach
